...
- Para instalar dependências do projeto:
  ...
  - acessar a pasta `backend` e executar o comando `npm install`;
  - acessar a pasta `frontend` e executar o comando `npm install`;

- Executar o projeto:

  - acessar a pasta `backend` e executar o comando `npm start`;
  - acessar a pasta `frontend` e executar o comando `npm start`;
